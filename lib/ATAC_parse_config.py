...
def MakeConf(fastq_1,fastq_2,barcode_file,outname,geneanno,maptool,mapindex,P,X,trim5,fover,Clean,species,cell_cutoff,peak_cutoff):
...
### config template
CONFIG_TEMPLATE = os.path.join(DrSeq2pipe.__path__[0], "Config/ATAC_template.conf")
